...
<Simulation> system time: 8
  ...
  Blocked List
    Pid: 2   state: BLOCKED  start: 2   used: 2   quant: 0   event: 22 
  Blocked List
...
<Simulation> system time: 10
  ...
  Blocked List
    Pid: 3   state: BLOCKED  start: 3   used: 2   quant: 0   event: 17 
    Pid: 2   state: BLOCKED  start: 2   used: 2   quant: 0   event: 22 
  Blocked List
...
<Simulation> system time: 11
  ...
  Ready Queue Head
    Pid: 2   state: READY    start: 2   used: 2   quant: 0   event: 0  
    Pid: 3   state: READY    start: 3   used: 2   quant: 0   event: 0  
  Ready Queue Tail
...
<Simulation> system time: 18
  ...
  CPU
    Pid: 2   state: RUNNING  start: 2   used: 5   quant: 3   event: 0  
  CPU
...
<Simulation> system time: 19
  ...
  CPU
    Pid: 3   state: RUNNING  start: 3   used: 3   quant: 1   event: 0  
  CPU
...
<Simulation> system time: 20
  ...
  CPU
    Pid: 3   state: RUNNING  start: 3   used: 4   quant: 2   event: 0  
  CPU
...
<Simulation> system time: 21
  ...
  CPU
    Pid: 3   state: RUNNING  start: 3   used: 5   quant: 3   event: 0  
  CPU
